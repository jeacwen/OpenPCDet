...
print("*******************************************************************************************************",os.getcwd())
#sys.path.append('/home/dl/users/wending/3D_Detect/OpenPCDet/pcdet/datasets/')
#sys.path.append('/home/dl/users/wending/3D_Detect/OpenPCDet/pcdet/')
from  pcdet.datasets.kitti.kitti_dataset  import kitti_utils# 从当前目录导入kitti_utils模块
    ...
    def get_infos(self, train_or_val,num_workers=4, has_label=True, count_inside_pts=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            if train_or_val =="train":
                lidar_points='/home/dl/users/wending/3D_Detect/OpenPCDet/data/lidar/train/points/'
                lidar_labels='/home/dl/users/wending/3D_Detect/OpenPCDet/data/lidar/train/labels/'
            else:
            ...
            if has_label:
                ...
                if count_inside_pts:
                    ...
                    np.savetxt(os.path.join(lidar_points,sample_idx)+".txt", pts_fov, fmt="%f", delimiter=" ")
                    ###save points###
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    ...
    train_or_val="val"
    kitti_infos_val = dataset.get_infos(train_or_val,num_workers=workers, has_label=True, count_inside_pts=True)
